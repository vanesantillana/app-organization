...
export const isSameMonth = (firstDate, secondDate) => {
  ...
  return firstDate.getMonth() === secondDate.getMonth() && firstDate.getYear() === secondDate.getYear();
};
...
export const isSalaryIncrease = (data, currentItem) => {
  ...
  return lastSalary && Number(lastSalary.salary) < Number(currentItem.salary) ? lastSalary.salary : "";
}
